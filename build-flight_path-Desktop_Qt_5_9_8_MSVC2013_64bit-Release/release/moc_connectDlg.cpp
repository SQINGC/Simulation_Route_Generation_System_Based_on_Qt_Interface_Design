...
#include "../../../../CurrentSystem/flight_path/flight_path202302081515/connectDlg.h"
...
QT_MOC_LITERAL(1, 11, 4), // "Port"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 20), // "on_btnCancel_clicked"
QT_MOC_LITERAL(4, 38, 16) // "on_btnOk_clicked"

    },
    "connectDlg\0Port\0\0on_btnCancel_clicked\0"
    "on_btnOk_clicked"
};
...
void connectDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Port((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (connectDlg::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&connectDlg::Port)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject connectDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_connectDlg.data,
      qt_meta_data_connectDlg,  qt_static_metacall, nullptr, nullptr}
};
